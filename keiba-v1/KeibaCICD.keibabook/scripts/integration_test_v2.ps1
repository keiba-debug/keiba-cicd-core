...
function Invoke-LegacyTests {
    ...
    # main.py ヘルプテスト
Test-Command -TestName "main.py ヘルプ表示" -Command "python src/keibabook/main.py --help" -Category "LegacyTests" -ExpectedOutput "race-id"
...
function Invoke-LightDataTests {
    ...
    if ($HtmlFiles) {
        ...
        Test-Command -TestName "HTMLパーステスト" -Command "python src/keibabook/main.py --mode parse_only --html-file `"$SampleHtml`" --race-id 202502041211" -Category "CliTests"
    } else {

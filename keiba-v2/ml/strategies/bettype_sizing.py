...
# v2 配分 (単/複 share)。 ★strong は単を薄く combo へ・mid で単最厚・weak は流しへ★ (山型)。
FIXED_SHARES_V2 = {
    "strong": (0.15, 0.15),   # ◎断然=単で儲からない → 単薄く 15/15/70 (combo=70%厚く)
    "mid":    (0.30, 0.20),   # 手頃な◎=単で取れる → 単を一番厚く 30/20/50
    "weak":   (0.15, 0.10),   # 団子=軸不確実 → 単薄く流しへ 15/10/75
}

          ...
          <nav className="ml-2 flex items-center gap-1 rounded-full bg-muted/40 p-1 border">
              ...
              <div className="absolute left-0 mt-2 w-56 rounded-xl border bg-background shadow-lg overflow-hidden">
                ...
                >
                  <span className="flex items-center gap-2">
                    ...
                    <span>
                      ...
                      <span className="block text-xs text-muted-foreground mt-0.5">モデル体系・バージョン管理</span>
                    </span>
                  </span>
                </Link>
                <Link
                ...
                >
                  <span className="flex items-center gap-2">
                    <span>🎯</span>
                    <span>
                      <span className="font-medium">Selective 候補</span>
                      <span className="block text-xs text-muted-foreground mt-0.5">重賞のみP top1 (BT ROI 203%)</span>
                    </span>
                  </span>
                </Link>
              </div>
              ...
              <div className="absolute left-0 mt-2 w-56 rounded-xl border bg-background shadow-lg overflow-hidden">
                ...
                >
                  <span className="flex items-center gap-2">
                    <span>🎯</span>
                    <span>
                      <span className="font-medium">エッジ検証</span>
                      <span className="block text-xs text-muted-foreground mt-0.5">gap5単勝エッジの地図・配分シミュ</span>
                    </span>
                  </span>
                </Link>
                <Link
            ...
            <details className="relative group" ref={analysisMenuRef}>
              ...
              <div className="absolute left-0 mt-2 w-64 rounded-xl border bg-background shadow-lg overflow-hidden">
                ...
                <Link
                  href="/analysis/jockey-close-finish"
                  onClick={() => { if (analysisMenuRef.current) analysisMenuRef.current.open = false; }}
                  className="block px-4 py-2.5 text-sm text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
                >
                  <span className="flex items-center gap-2">
                    <span>🏇</span>
                    <span>
                      <span className="font-medium">騎手接戦分析</span>
                      <span className="block text-xs text-muted-foreground mt-0.5">接戦勝率・成長トレンド・条件別</span>
                    </span>
                  </span>
                </Link>
                <Link
                  href="/analysis/race-context-engine"
                  onClick={() => { if (analysisMenuRef.current) analysisMenuRef.current.open = false; }}
                  className="block px-4 py-2.5 text-sm text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
                >
                  <span className="flex items-center gap-2">
                    <span>📚</span>
                    <span>
                      <span className="font-medium">レース文脈エンジン</span>
                      <span className="block text-xs text-muted-foreground mt-0.5">競馬5冊 ML知見・実装状況まとめ</span>
                    </span>
                  </span>
                </Link>
                <Link
                  href="/analysis/comment-profiles"
                  onClick={() => { if (analysisMenuRef.current) analysisMenuRef.current.open = false; }}
                  className="block px-4 py-2.5 text-sm text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
                >
                  <span className="flex items-center gap-2">
                    <span>💬</span>
                    <span>
                      <span className="font-medium">発信者コメント分析</span>
                      <span className="block text-xs text-muted-foreground mt-0.5">調教師・騎手コメントの信頼度・口ぐせ</span>
                    </span>
                  </span>
                </Link>

...
Y:\CK_DATA\
  ├── 2024\
  │   ├── 202401\
  │   │   ├── WC020240101.DAT  # 坂路調教（美浦）
  │   │   ├── WC120240101.DAT  # 坂路調教（栗東）
  │   │   ├── HC020240101.DAT  # コース調教（美浦）
  │   │   └── HC120240101.DAT  # コース調教（栗東）
  │   └── ...
  └── 2026\
      └── 202601\
          └── ...
...
| パターン | 説明 |
|---------|------|
| `WC{場所}{YYYYMMDD}.DAT` | 坂路調教データ |
| `HC{場所}{YYYYMMDD}.DAT` | コース調教データ |
...
| 27-30 | 4 | Time4F | 4Fタイム |
| 31-34 | 4 | Time3F | 3Fタイム |
| 35-37 | 3 | 不明 | |
| 38-40 | 3 | Lap2 | Lap2 |
| 41-43 | 3 | Lap1 | Lap1 |
